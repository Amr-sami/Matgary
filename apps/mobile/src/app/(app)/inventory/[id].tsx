...
const styles = StyleSheet.create({
  ...
  quickText: { fontFamily: fonts.semibold, fontSize: 14, color: colors.text, fontVariant: ["tabular-nums"] },
  ...
  editBtnText: { fontFamily: fonts.semibold, fontSize: 14, color: colors.accent },
  ...
  historyTime: { fontFamily: fonts.regular, fontSize: 12, color: colors.textSecondary, fontVariant: ["tabular-nums"] },
  historyMeta: { flexDirection: "row", alignItems: "center", flexWrap: "wrap", gap: spacing.sm },
  historyDelta: { fontFamily: fonts.semibold, fontSize: 13, fontVariant: ["tabular-nums"] },
  historyDown: { color: colors.warningStrong },
  historyAfter: { fontFamily: fonts.regular, fontSize: 12, color: colors.textSecondary, fontVariant: ["tabular-nums"] },
