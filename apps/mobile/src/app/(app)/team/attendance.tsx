...
const styles = StyleSheet.create({
  ...
  dateChipText: { fontFamily: fonts.medium, fontSize: 14 },
  ...
  initial: { fontFamily: fonts.bold, fontSize: 16, color: colors.accent },
  ...
  eventTime: { fontFamily: fonts.semibold, fontVariant: ["tabular-nums"] },
  eventReview: { color: colors.warningStrong, fontSize: 12 },
