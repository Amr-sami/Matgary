...
const styles = StyleSheet.create({
  ...
  infoLabel: { ...RTL_TEXT, fontFamily: fonts.regular, fontSize: 14, color: colors.textSecondary },
  ...
  statValue: { ...RTL_TEXT, fontFamily: fonts.bold, fontSize: 18, color: colors.text, fontVariant: ["tabular-nums"] },
  ...
  shiftDate: { ...RTL_TEXT, fontFamily: fonts.medium, fontSize: 13, color: colors.text, fontVariant: ["tabular-nums"] },
  shiftTime: { ...RTL_TEXT, fontFamily: fonts.regular, fontSize: 13, color: colors.textSecondary, fontVariant: ["tabular-nums"] },
  shiftHours: { ...RTL_TEXT, fontFamily: fonts.semibold, fontSize: 13, color: colors.text, marginStart: "auto" },
  grow: { flex: 1 },
