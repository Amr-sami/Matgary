...
const styles = StyleSheet.create({
  ...
  itemTotal: { ...RTL_TEXT, fontFamily: fonts.bold, fontSize: 16, color: colors.text, fontVariant: ["tabular-nums"] },
  ...
  lineAmt: { ...RTL_TEXT, fontFamily: fonts.medium, fontSize: 13, color: colors.text, fontVariant: ["tabular-nums"] },
  errorBox: {
    flexDirection: "row",
