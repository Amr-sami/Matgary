...
const styles = StyleSheet.create({
  ...
  th: { fontFamily: fonts.medium, fontSize: 12, color: colors.textSecondary },
  ...
  lineNum: { fontFamily: fonts.regular, fontSize: 14, color: colors.text, paddingTop: 2 },
  lineTotal: { fontFamily: fonts.semibold },
  ...
  totalLabelStrong: { fontFamily: fonts.semibold, color: colors.text },
  totalValue: { fontFamily: fonts.medium, fontSize: 14, color: colors.text, fontVariant: ["tabular-nums"] },
  totalValueStrong: { fontFamily: fonts.bold, fontSize: 17 },
  ...
  returnedNoteText: { fontFamily: fonts.medium, fontSize: 13, color: colors.textSecondary },
});
