...
const styles = StyleSheet.create({
  ...
  rankText: { fontFamily: fonts.semibold, fontSize: 12, color: colors.neutralText, fontVariant: ["tabular-nums"] },
  rankTextTop: { color: colors.card },
  name: { flex: 1, fontFamily: fonts.semibold, fontSize: 15, color: colors.text, ...RTL_TEXT },
  value: { fontFamily: fonts.bold, fontSize: 15, color: colors.text, fontVariant: ["tabular-nums"] },
